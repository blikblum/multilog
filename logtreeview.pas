unit LogTreeView;
{§< @abstract(Unit to display the TLogger's messages in a TTreeView.)}
...
{§ TLogTreeView is a way to display the TLogger'messages, with images.}
{$ENDREGION}
  ...
  begin
    case AMsg.MsgType of
      ...
      ltExitMethod:
       ...
       ltCallStack,ltStrings,ltHeapInfo,ltException,ltMemory:
         begin
           FLastNode:=AddChild(FParentNode,AText);
