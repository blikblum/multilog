...
procedure TLoggerLCLHelper.SendBitmap(Classes: TDebugClasses; const AText: String;
  ABitmap: TBitmap);
var
  AStream: TStream;
begin
...
procedure TLoggerLCLHelper.SendColor(Classes: TDebugClasses; const AText: String;
  AColor: TColor);
begin
